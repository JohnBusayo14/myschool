...

{
  units?.map( 
     (unit, index) => {
      return (
    <TouchableOpacity key={index} onPress={() => navigation.navigate('Units',{unit})} className=' w-3/4 h-44 flex flex-col  bg-[#255f85]  rounded-md justify-center items-center align-middle shadow-2xl' >
