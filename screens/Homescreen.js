...
const Homescreen = ({navigation}) => {
  return (
    <View className=" w-full h-screen flex-1 items-start justify-between bg-white">
  
  <View className=' w-full h-1/2'>
  <Text className=' text-4xl px-2 py-10 text-black font-extrabold italic'>THE GOSPEL FAITH MISSION INT'</Text>
